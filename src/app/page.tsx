...
import {
  ...
  Landmark, LogIn, Mail, MapPin, MapPinned, Menu, Newspaper, Phone, Power, Quote,
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    nodes.forEach((node, index) => {
      node.style.setProperty("--reveal-delay", `${Math.min(index % 5, 4) * 48}ms`);
    ...
    <main>
      <section id="trang-chu" className="public-hero public-hero-v2">
        ...
        <div className="public-container public-hero-content public-hero-content-v2">
          ...
          <div className="public-hero-video-rail" data-reveal="up"><PublicVideoRail /></div>
          <div className="public-hero-dashboard" data-reveal="right"><PublicLiveMetrics /></div>
        </div>

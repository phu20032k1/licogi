...
const COPY = {
  vi: {
    ...
    click: "Tra cứu", metric: "số liệu tổng quan", city: "theo địa phương", type: "theo lĩnh vực", customer: "theo quốc gia chủ đầu tư", scale: "theo quy mô hợp đồng", point: "vị trí công trình", updated: "Dữ liệu được cập nhật tập trung",
    metricDesc: "Xem danh mục theo số liệu tổng quan", cityDesc: "Tra cứu công trình theo địa phương", typeDesc: "Tra cứu theo nhóm lĩnh vực thi công", customerDesc: "Tra cứu theo quốc gia chủ đầu tư", scaleDesc: "So sánh công trình theo giá trị hợp đồng", pointDesc: "Xem vị trí và hồ sơ từng công trình", updatedDesc: "Dữ liệu dự án được quản lý và cập nhật tập trung",
  ...
  en: {
    line1: "BUILDING VALUE", line2: "CREATING THE FUTURE", lead: "Professional general contractor for industrial, civil and technical infrastructure projects.", completed: "Completed projects", ongoing: "Projects under construction", provinces: "Provinces / cities covered", countries: "Customer countries", value: "VND billion project value", investors: "Trusted by investors", explore: "Explore projects", map: "View nationwide map", national: "Projects nationwide", clickTitle: "Explore project data", click: "Explore", metric: "metrics", city: "by location", type: "by sector", customer: "by investor country", scale: "by contract scale", point: "project locations", updated: "Centralized project data", metricDesc: "Open the matching project list", cityDesc: "View projects by location", typeDesc: "Filter by project sector", customerDesc: "View projects by investor country", scaleDesc: "Compare projects by contract value", pointDesc: "Open project locations and profiles", updatedDesc: "Project data is maintained centrally", experience: "20+ years", experienceSub: "Experience", commitment: "100% commitment", commitmentSub: "Schedule · Quality · Safety", engineers: "500+ engineers", engineersSub: "Professional team", standards: "International standards", standardsSub: "ISO 9001, 14001, 45001", equipment: "Modern equipment", equipmentSub: "Advanced construction technology",
  },
  ja: {
    line1: "価値を築き", line2: "未来を創る", lead: "産業・民生・技術インフラ工事に対応するプロフェッショナルな総合建設会社。", completed: "完成工事", ongoing: "施工中工事", provinces: "展開した省・都市", countries: "顧客の国・地域", value: "工事価値（10億VND）", investors: "投資家と共に", explore: "工事を見る", map: "全国マップ", national: "全国の工事", clickTitle: "工事データを検索", click: "検索", metric: "概要データ", city: "地域別", type: "工事種別", customer: "投資家国別", scale: "契約規模別", point: "工事位置", updated: "一元管理されたデータ", metricDesc: "該当する工事一覧を表示", cityDesc: "地域別の工事を表示", typeDesc: "工事種別で絞り込み", customerDesc: "投資家国別に表示", scaleDesc: "契約金額別に工事を比較", pointDesc: "工事位置と詳細を表示", updatedDesc: "工事データを一元管理", experience: "20年以上", experienceSub: "経験", commitment: "100%の約束", commitmentSub: "工程 · 品質 · 安全", engineers: "500名以上", engineersSub: "専門エンジニア", standards: "国際規格", standardsSub: "ISO 9001, 14001, 45001", equipment: "最新設備", equipmentSub: "先進施工技術",
  },
  ko: {
    line1: "가치를 건설하고", line2: "미래를 창조합니다", lead: "산업·민간·기술 인프라 프로젝트를 위한 전문 종합건설사입니다.", completed: "완료 프로젝트", ongoing: "시공 중 프로젝트", provinces: "진출 성·도시", countries: "고객 국가", value: "프로젝트 가치(십억 VND)", investors: "투자자와 함께", explore: "프로젝트 보기", map: "전국 지도 보기", national: "전국 프로젝트", clickTitle: "프로젝트 데이터 조회", click: "조회", metric: "요약 지표", city: "지역별", type: "분야별", customer: "투자자 국가별", scale: "계약 규모별", point: "프로젝트 위치", updated: "통합 프로젝트 데이터", metricDesc: "해당 프로젝트 목록 보기", cityDesc: "지역별 프로젝트 보기", typeDesc: "프로젝트 분야별 필터", customerDesc: "투자자 국가별 보기", scaleDesc: "계약 금액별 프로젝트 비교", pointDesc: "프로젝트 위치 및 상세 보기", updatedDesc: "프로젝트 데이터를 통합 관리", experience: "20년+", experienceSub: "경험", commitment: "100% 약속", commitmentSub: "공정 · 품질 · 안전", engineers: "500명+", engineersSub: "전문 엔지니어", standards: "국제 표준", standardsSub: "ISO 9001, 14001, 45001", equipment: "현대 장비", equipmentSub: "첨단 시공 기술",
  },
  zh: {
    line1: "构筑价值", line2: "共创未来", lead: "面向工业、民用及技术基础设施项目的专业建筑总承包商。", completed: "已完工项目", ongoing: "在建项目", provinces: "已覆盖省市", countries: "客户国家/地区", value: "项目价值（十亿越南盾）", investors: "与投资者同行", explore: "探索项目", map: "查看全国地图", national: "全国项目", clickTitle: "查询工程项目数据", click: "查询", metric: "总体数据", city: "按地区", type: "按工程类型", customer: "按投资方国家", scale: "按合同规模", point: "项目位置", updated: "集中管理的项目数据", metricDesc: "查看对应项目列表", cityDesc: "查看当地项目", typeDesc: "按项目类型筛选", customerDesc: "按投资方国家查看", scaleDesc: "按合同金额比较项目", pointDesc: "查看项目位置和详情", updatedDesc: "项目数据集中管理与更新", experience: "20+年", experienceSub: "经验", commitment: "100%承诺", commitmentSub: "进度 · 品质 · 安全", engineers: "500+工程师", engineersSub: "专业团队", standards: "国际标准", standardsSub: "ISO 9001, 14001, 45001", equipment: "现代设备", equipmentSub: "先进施工技术",
  },
} as const;
...
export default function PublicHomepageDashboard() {
  ...
  const valueRangeItems = ["<100 tỷ", "100-200 tỷ", "200-500 tỷ", ">500 tỷ"].map((range) => ({ range, count: projects.filter((project) => project.valueRange === range).length }));

  const reachCard = hasInvestorCountryData
    ...
    : { key: "scale", title: `${t.click} ${t.scale}`, desc: t.scaleDesc, href: "/portfolio/projects", visual: <div className={styles.miniList}>{valueRangeItems.map((item) => <span key={item.range}>{item.range}<b>{item.count}</b></span>)}</div> };
